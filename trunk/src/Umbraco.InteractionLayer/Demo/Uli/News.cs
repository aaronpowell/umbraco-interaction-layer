...
namespace Umbraco.Generated
{
    ...
    /// 
    /// </summary>
    [UmbracoDocTypeInfo(Alias="News", Id=1062)]
    public partial class News : DocTypeBase
    {
        ...
        public News(System.Guid uniqueId) : 
                this(new umbraco.cms.businesslogic.web.Document(uniqueId))
        {
        }
        
        protected internal News(umbraco.cms.businesslogic.web.Document source) : 
                base(source)
        {
        }
        ...
        /// 
        /// </summary>
        [UmbracoFieldInfo(DisplayName="News Teaser", Mandatory=false, IsCustom=true, Alias="NewsTeaser")]
        [System.Runtime.Serialization.DataMemberAttribute(Name="NewsTeaser")]
        public virtual string NewsTeaser
        {
            get
            {
                return this._NewsTeaser;
            }
            set
            {
                if ((this.NewsTeaser != value))
                {
                    this.RaisePropertyChanging();
                    this._NewsTeaser = value;
                    this.IsDirty = true;
                    this.RaisePropertyChanged("NewsTeaser");
                }
            }
        }
