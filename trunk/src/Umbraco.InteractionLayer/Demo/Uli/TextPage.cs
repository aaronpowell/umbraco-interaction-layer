...
namespace Umbraco.Generated
{
    ...
    /// 
    /// </summary>
    [UmbracoDocTypeInfo(Alias="Text Page", Id=1057)]
    public partial class TextPage : DocTypeBase
    {
        ...
        public TextPage(int id) : 
                this(new umbraco.cms.businesslogic.web.Document(id))
        {
        }
        
        public TextPage(System.Guid uniqueId) : 
                this(new umbraco.cms.businesslogic.web.Document(uniqueId))
        {
        }
        
        protected internal TextPage(umbraco.cms.businesslogic.web.Document source) : 
                base(source)
        {
        }
