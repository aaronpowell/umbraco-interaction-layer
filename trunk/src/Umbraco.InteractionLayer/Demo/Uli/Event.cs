...
namespace Umbraco.Generated
{
    ...
    /// 
    /// </summary>
    [UmbracoDocTypeInfo(Alias="Event", Id=1061)]
    public partial class Event : DocTypeBase
    {
        ...
        public Event(System.Guid uniqueId) : 
                this(new umbraco.cms.businesslogic.web.Document(uniqueId))
        {
        }
        
        protected internal Event(umbraco.cms.businesslogic.web.Document source) : 
                base(source)
        {
        }
        ...
        /// 
        /// </summary>
        [UmbracoFieldInfo(DisplayName="Event Date", Mandatory=false, IsCustom=true, Alias="EventDate")]
        [System.Runtime.Serialization.DataMemberAttribute(Name="EventDate")]
        ...
        /// 
        /// </summary>
        [UmbracoFieldInfo(DisplayName="Event Teaser", Mandatory=false, IsCustom=true, Alias="EventTeaser")]
        [System.Runtime.Serialization.DataMemberAttribute(Name="EventTeaser")]
        public virtual string EventTeaser
        {
            get
            {
                return this._EventTeaser;
            }
            set
            {
                if ((this.EventTeaser != value))
                {
                    this.RaisePropertyChanging();
                    this._EventTeaser = value;
                    this.IsDirty = true;
                    this.RaisePropertyChanged("EventTeaser");
                }
            }
        }
